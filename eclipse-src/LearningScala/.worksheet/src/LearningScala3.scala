object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  def transformStr(s: String, f: String => String) : String = {
  	f(s)
  };System.out.println("""transformStr: (s: String, f: String => String)String""");$skip(64); 
  
  def toUpper(s: String) : String = {
  	s.toUpperCase()
  };System.out.println("""toUpper: (s: String)String""");$skip(45); 
  
  println(transformStr("hello", toUpper));$skip(56); 
