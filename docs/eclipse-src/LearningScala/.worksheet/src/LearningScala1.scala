object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(129); 
  ...
  helloThere = hello + " Dude!";$skip(22); 
  println(helloThere);$skip(299); 
  ...
  val moreStuff = immutableHelloThere + "yeah";System.out.println("""moreStuff  : String = """ + $show(moreStuff ));$skip(20); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(307); 
  ...
  val doublePi = pi * 2;System.out.println("""doublePi  : Double = """ + $show(doublePi ));$skip(37); ;
  println(f"Value is: $doublePi%5f")}
