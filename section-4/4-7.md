# Improve Quality of Movie Simlarities

* Improve the results! Some ideas to try:
    - Discard bad ratings - only recommend good movies
    - Try different similarity metrics (Pearson Correlation Coefficient, Jaccardi Coefficient, Conditional Probability)
    - Adjust the thresholds for minimm co-raters or minimum score
